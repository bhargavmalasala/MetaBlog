...
>
  ...
  <button
    className="w-full py-2 px-6 bg-blue-600 text-white font-medium rounded-md shadow-md transform transition-all duration-300 ease-in-out hover:bg-blue-700 hover:scale-105 hover:shadow-blue-500/50 focus:outline-none"
  >
    SignIn
  </button>
</form>
